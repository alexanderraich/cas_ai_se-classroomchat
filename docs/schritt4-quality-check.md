...
4. **Komplettheit** — alle Features F1–F4 sind durch Anforderungen abgedeckt; keine Lücken im Hauptpfad.
...
| FA-07, FA-08         | ✓ | Kontrolle über Mitgliederkreis ist Kernnutzen des Eigentümer-Konzepts.                   |
| FA-10                | ✓ | Sicherheits-Mindeststandard; ohne diese Anforderung bricht das Eigentümer-Modell.        |
| FA-11                | ✓ | Navigation ist Voraussetzung für Mehrgruppen-Nutzung.                                    |
...
| F2 — Gruppenverwaltung   | FA-04..FA-10                  | UC-2..UC-6    | ✓ |
| F3 — Mitgliedschaft/Nav. | FA-11, FA-17                  | —             | ✓ |
| F4 — Nachricht senden    | FA-12, FA-13, FA-14, FA-15    | UC-8          | ✓ |
...
| FA-04 | Das System MUSS einem Mitglied das Erstellen einer neuen Gruppe ermöglichen; der Ersteller wird automatisch Eigentümer und Erstmitglied.                                 |
...
| FA-07 | Das System MUSS dem Eigentümer einer Gruppe erlauben, Mitglieder hinzuzufügen.                                                                                           |
| FA-08 | Das System MUSS dem Eigentümer einer Gruppe erlauben, Mitglieder (ausser sich selbst) zu entfernen.                                                                      |
| FA-09 | Das System MUSS dem Eigentümer einer Gruppe erlauben, die Gruppe inkl. aller Mitgliedschaften und Nachrichten zu löschen.                                                |
| FA-10 | Das System MUSS Schreib-/Konfigurationsaktionen an einer Gruppe nur dem Eigentümer erlauben (HTTP 403 sonst).                                                            |
| FA-11 | Das System MUSS jedem Mitglied die Liste seiner eigenen Gruppen anzeigen.                                                                                                |
| FA-12 | Das System MUSS einem Mitglied das Senden einer Textnachricht in einer Gruppe ermöglichen, in der es Mitglied ist.                                                       |
...
| FA-17 | Das System MUSS verhindern, dass Nicht-Mitglieder Nachrichten einer Gruppe lesen oder schreiben.                                                                         |
